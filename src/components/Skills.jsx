    ...
    <section className="section">
        ...
        <div className="grid grid-2">
          <div>
            ...
            <ul className="achievements-list">
              ...
              <li>AI Applications and development</li>
          ...
          <div>
            ...
            <ul className="achievements-list">
              ...
              <li>Competitions winner in inter-collge tech fests</li>
      ...
      <div className="cta-section">
        ...
        <p>
          ...
          Currently exploring GenAI, Agentic AI, and advanced python libraries.
